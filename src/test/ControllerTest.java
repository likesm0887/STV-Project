...
//        MobileElement element = (MobileElement) driver.findElement(By.xpath("//*[@class='android.widget.RelativeLayout' and @index='0']"));
    ...
    public void quickAddTest(){
        // select folder
        MobileElement folderList = (MobileElement) driver.findElement(By.xpath("//*[@class='android.widget.RelativeLayout' and @index='0']"));
        folderList.click();
        // click quick add
        MobileElement quickAdd = (MobileElement) driver.findElement(By.xpath("//*[@index='0']/android.widget.ImageView[@resource-id='org.dmfs.tasks:id/quick_add_task']"));
        quickAdd.click();
...
//        editBtn.click();
        ...
        options.click();
        // edit text
        MobileElement editText = (MobileElement) driver.findElement(By.xpath("//*[@resource-id='android:id/input']"));
        editText.sendKeys("Test");
        // save and continue
        MobileElement saveAndContinueBtn = (MobileElement) driver.findElement(By.xpath("//*[@resource-id='android:id/button2']"));
        ...
        // save
        MobileElement saveBtn = (MobileElement) driver.findElement(By.xpath("//*[@resource-id='android:id/button1']"));
        saveBtn.click();
    }
